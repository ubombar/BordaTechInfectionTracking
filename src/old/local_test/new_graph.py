...
class TreeNode():
    ...
    def __init__(self, userid, name, date, level=0, parent=None):
        self.parent = None
...
class TimeLine():
    ...
    def register(self, userid:str, date:datetime, covid:bool):
    ...
    def to(self):
        return {userid:[{    "Date": datetime.strftime(date, TIME_FORMAT), 
                            "Status": status 
